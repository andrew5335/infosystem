...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#infoExcelDownload").click(function(e){
			...
			oilcon = $('input[name="oilcondition"]:checked').val();
			contamicon = $('input[name="contamicondition"]:checked').val();
			wearcon = $('input[name="wearcondition"]:checked').val();
			
			$("#companyIdx1").val(companyIdx);
			$("#specIdx1").val(specIdx);
			$("#sampleIdx1").val(sampleIdx);
			$("#searchCol1").val(searchCol);
			$("#startDate1").val(startDate);
			$("#endDate1").val(endDate);
			$("#searchKey1").val(searchKey);
			$("#companyName1").val(companyName);
			$("#specName1").val(specName);
			$("#sampleName1").val(sampleName);
			$("#smplPoint1").val(smplPoint);
			$("#manager1").val(manager);
			$("#standard1").val(standard);
			$("#viscoval1").val(viscoval);
			$("#acidval1").val(acidval);
			$("#oilcon1").val(oilcon);
			$("#contamicon1").val(contamicon);
			$("#wearcon1").val(wearcon);
			
			$("#excelForm").submit();
			
// 			alert("oil condition : " + oilcon);
// 			alert("contamination condition : " + contamicon);
// 			alert("wear condition : " + wearcon);
			
// 			if(oilcon == "undefined") {oilcon = "";}
// 			if(contamicon == "undefined") {contamicon = "";}
// 			if(wearcon == "undefined") {wearcon = "";}
			...
			//location.href="/ajax/infoAnalysisExcel.info?companyIdx="+companyIdx+"&specIdx="+specIdx+"&sampleIdx="+sampleIdx+"&searchCol="+searchCol+"&startDate="+startDate+"&endDate="+endDate+"&searchKey="+searchKey+"&companyName="+encodeURI(companyName)+"&specName="+encodeURI(specName)+"&sampleName="+encodeURI(sampleName)+"&smplPoint="+smplPoint+"&manager="+encodeURI(manager)+"&standard="+standard+"&viscoval="+viscoval+"&acidval="+acidval+"&oilcon="+oilcon+"&contamicon="+contamicon+"&wearcon="+wearcon;
...
<form name="excelForm" id="excelForm" action="/ajax/infoAnalysisExcel.info" method="POST">
    <input type="hidden" id="companyIdx1" name="companyIdx1" value="">
    <input type="hidden" id="specIdx1" name="specIdx1" value="">
    <input type="hidden" id="sampleIdx1" name="sampleIdx1" value="">
    <input type="hidden" id="searchCol1" name="searchCol1" value="">
    <input type="hidden" id="startDate1" name="startDate1" value="">
    <input type="hidden" id="endDate1" name="endDate1" value="">
    <input type="hidden" id="searchKey1" name="searchKey1" value="1">
    <input type="hidden" id="companyName1" name="companyName1" value="">
    <input type="hidden" id="specName1" name="specName1" value="">
    <input type="hidden" id="sampleName1" name="sampleName1" value="">
    <input type="hidden" id="smplPoint1" name="smplPoint1" value="">
    <input type="hidden" id="manager1" name="manager1" value="">
    <input type="hidden" id="standard1" name="standard1" value="">
    <input type="hidden" id="viscoval1" name="viscoval1" value="">
    <input type="hidden" id="acidval1" name="acidval1" value="">
    <input type="hidden" id="oilcon1" name="oilcon1" value="">
    <input type="hidden" id="contamicon1" name="contamicon1" value="">
    <input type="hidden" id="wearcon1" name="wearcon1" value="">
</form>
